...
class UserAnswerLog(models.Model):
    ...
    score = models.IntegerField(verbose_name=u"得分", default=-1)
    score2 = models.IntegerField(verbose_name=u"自动评分2", default=-1)
    mscore = models.IntegerField(verbose_name=u"人工评分", default=-1)
    paper_log_id = models.IntegerField(verbose_name=u"记录id", default=None)
